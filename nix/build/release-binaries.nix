...
in [
  {
    ...
    description = ''
      ...
      For more information see - http://tezos.gitlab.io/introduction/howtouse.html#client
    '';
  ...
  }
  {
    ...
    description = ''
      CLI adminitrator tool with additional possibilities.
      For more information please check - http://tezos.gitlab.io/user/various.html#octez-admin-client
    '';
    supports = protocolsFormatted;
  }
  {
    ...
    description = ''
      ...
      For more information please check - http://tezos.gitlab.io/introduction/howtouse.html#node
    '';
    supports = protocolsFormatted;
  }
  {
  ...
  }
  {
    ...
    description = ''
      ...
      For more info please check - http://tezos.gitlab.io/user/key-management.html#signer
    '';
    supports = protocolsFormatted;
  }
  {
    ...
    description = ''
      ...
      For more info please check - http://tezos.gitlab.io/introduction/howtouse.html#codec
    '';
    supports = protocolsFormatted;
  }
  {
    ...
    description = ''
      ...
      For more info please check - http://tezos.gitlab.io/active/smart_rollups.html
    '';
    supports = protocolsFormatted;
  }
] ++ builtins.concatMap (protocol: [
  {
    ...
    description = ''
      ...
      For more info please check - http://tezos.gitlab.io/introduction/howtorun.html#baker
    '';
    supports = protocol;
  }
  {
    ...
    description = ''
      ...
      For more info please check - http://tezos.gitlab.io/introduction/howtorun.html#accuser
    '';
    supports = protocol;
  }
  {
    ...
    description = ''
      ...
      For more info please check - http://tezos.gitlab.io/active/smart_rollups.html#tools
    '';
    supports = protocol;
  }
  {
